...
const shortcutGroups = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { key: 'g', action: 'Git screen' },
      { key: '8', action: 'Diff compare' },
      { key: '7', action: 'Git log diff' },
      { key: '`', action: 'Settings' },
    ],
  },
  {
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { key: 'Ctrl+G', action: 'Go to line' },
      { key: 'Ctrl+W', action: 'Toggle word wrap' },
  ...
  },
  {
    title: 'Diff Compare',
    shortcuts: [
      { key: '8', action: 'Start folder diff (2 panels: immediate)' },
      { key: 'Enter', action: 'View file diff / Toggle directory' },
      { key: '← →', action: 'Collapse / Expand directory' },
      { key: 'e / c', action: 'Expand all / Collapse all' },
      { key: 'Space', action: 'Select / Deselect item' },
      { key: 'F', action: 'Cycle filter (All/Diff/L/R)' },
      { key: 'N / S / D / Y', action: 'Sort by name/size/date/type' },
      { key: 'n / N (file diff)', action: 'Next / Previous change' },
      { key: 'Esc', action: 'Return to file panel' },
    ],
  },
  {
    title: 'Git',
    shortcuts: [
      { key: 'g', action: 'Open git screen' },
      { key: '7', action: 'Git log diff (compare 2 commits)' },
      { key: 'Tab', action: 'Switch tabs (Commit/Log/Branch)' },
      { key: 'Space', action: 'Stage / Unstage file' },
      { key: 'a', action: 'Stage all files' },
      { key: 'c', action: 'Commit' },
      { key: 'n / d', action: 'New / Delete branch' },
      { key: 'r', action: 'Refresh' },
      { key: 'Esc', action: 'Close git screen' },
    ],
  },
]
